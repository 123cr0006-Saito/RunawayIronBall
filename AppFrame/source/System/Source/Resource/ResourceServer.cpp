...
std::map<std::string, int> ResourceServer::_handleMap;
std::map<std::string, int> ResourceServer::_soundMap;
std::map<std::string, ResourceServer::Mult> ResourceServer::_multMap;
std::map<std::string, int >ResourceServer::_effekseerMap;
std::map<std::string, std::vector<int> >ResourceServer::_modelMap;
...
int ResourceServer::SearchSingle(std::string search_key, TYPE resouceType) {
	std::map<std::string, int>* resourceMap = nullptr;
...
std::pair<bool, int> ResourceServer::DeleteSearchSingle(std::string search_key, std::map<std::string, int>* resourceMap){
	auto itr = (*resourceMap).find(search_key);
	if (itr != (*resourceMap).end()) {
...
std::pair<bool, ResourceServer::Mult> ResourceServer::DeleteSearchMult(std::string search_key, std::map<std::string, ResourceServer::Mult>* resourceMap) {
	auto itr = (*resourceMap).find(search_key);
	if (itr != (*resourceMap).end()) {
		auto value = itr->second;
		(*resourceMap).erase(itr);
